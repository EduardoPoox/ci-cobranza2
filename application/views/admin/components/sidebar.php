<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <span><img src="../assets/img/logo/logo.png" alt="40" height="40"></span>
    </div>
    <div class="sidebar-brand-text mx-3">Gestión de cobranza</div>
  </a>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url('admin/poblacion'); ?>">
      <i class="fas fa-fw fa-street-view"></i>
      <span>Poblaciones</span></a>
  </li> 

  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url('admin/coordinador'); ?>">
